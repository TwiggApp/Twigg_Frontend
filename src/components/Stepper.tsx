...
export default function Stepper({ pagesLength, currrentPageIndex }: StepperProps) {
  ...
  return (
    <ul className="flex items-center w-[85%] ml-8">
      {Array.from({ length: pagesLength }).map((_, index) => {
        ...
        return (
          ...
          >
            ...
            <p className="absolute font-nunito text-[12px] text-center -bottom-9">
              Business Details
            </p>
          </li>
        );
